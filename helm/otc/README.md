...
export RELEASE_NAME='my-codbex-hades'
export NAMESPACE='default'

export DOMAIN='eu3.codbex.com'
export SUBDOMAIN='hades-demo'
```
...
- Prerequisites
    ...
    - Record for testing subdomain (for example `hades-demo`) which directs to the created ELB IP
...
kubectl delete secret hades-tls-secret
